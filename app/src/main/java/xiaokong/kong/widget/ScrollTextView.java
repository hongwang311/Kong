...
import xiaokong.kong.util.DensityUtil;

/**
 * Created by 空 on 2017/7/22.
 * <p>
 * 本控件只为点赞按钮而设定，设置的数字只能是>=0
 * 只有左右padding有用，上下如果设置padding水平还不到那一步。。。。
 * <p>
 * 模仿糗事百科的数字点赞控件，能力有限，勿喷= =
 */
...
public class ScrollTextView extends View {
    ...
    public ScrollTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        paint.setTextSize(DensityUtil.dip2px(context, 25));
